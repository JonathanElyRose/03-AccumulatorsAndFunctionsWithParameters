...
def two_circles():
    ...
    circle1 = rg.Circle(rg.Point(100, 150), 80)
    circle2 = rg.Circle(rg.Point(300, 150), 100)

    circle2.fill_color = "lime green"
...
def circle_and_rectangle():
    ...
    circle = rg.Circle(rg.Point(50,100), 50)
    circle.outline_thickness = 10
    circle.fill_color = 'green'

    rectangle = rg.Rectangle(rg.Point(200, 100), rg.Point(300, 300))
